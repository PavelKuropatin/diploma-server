...
class StyleTest {
    ...
    void validate__expectedMessage(String sourceAnchorStyle, String sourceStyle,
                                   String targetAnchorStyle, String targetStyle, String messages) {
        Style style = Style.builder()
                .sourceAnchorStyle(sourceAnchorStyle)
                .sourceStyle(sourceStyle)
                .targetAnchorStyle(targetAnchorStyle)
